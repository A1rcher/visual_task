...
struct MD5Sum< ::demo01_action::addintsAction_<ContainerAllocator> >
{
  ...
  {
    return "1f0f2b6fb22ea903c45208e0d1f900ff";
  }

  static const char* value(const ::demo01_action::addintsAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1f0f2b6fb22ea903ULL;
  static const uint64_t static_value2 = 0xc45208e0d1f900ffULL;
};
